...
impl AbsoluteY {
    pub fn new(base_address: u16) -> Self{
       AbsoluteY{ base_address }
    }
}

impl AddressingMode for AbsoluteY {
    fn read(&self, cpu: &CPU) -> u8 {
        let address = self.base_address.wrapping_add(cpu.index_register_y as u16);
...
mod test {
    ...
    fn basic_read() {
        ...
        let addressing_mode = AbsoluteY::new(0x83);
    ...
    fn no_wrap_around_read() {
        ...
        let addressing_mode = AbsoluteY::new(0x00FF);
    ...
    fn wrap_around_read() {
        ...
        let addressing_mode = AbsoluteY::new(0xFFFE);
    ...
    fn wrap_around_write() {
        ...
        let addressing_mode = AbsoluteY::new(0xFFFD);
        addressing_mode.write(&mut cpu, 0x09);
